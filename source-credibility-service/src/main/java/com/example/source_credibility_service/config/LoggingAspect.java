...
public class LoggingAspect {
    ...
    @Around("execution(* com.example.source_credibility_service..controller..*(..)) || " +
            "execution(* com.example.source_credibility_service..service..*(..)) || " +
            "execution(* com.example.source_credibility_service..repo..*(..))")
