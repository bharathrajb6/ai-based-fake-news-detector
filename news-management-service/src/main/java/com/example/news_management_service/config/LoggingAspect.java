...
public class LoggingAspect {
    ...
    @Around("execution(* com.example.news_management_service..controller..*(..)) || " +
            "execution(* com.example.news_management_service..service..*(..)) || " +
            "execution(* com.example.news_management_service..repo..*(..))")
